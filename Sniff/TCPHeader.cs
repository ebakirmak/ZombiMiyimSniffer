...
namespace Sniffer
{
    public class TCPHeader
    {
        ...
        private byte[] byTCPData = new byte[65556];//Data carried by the TCP packet
        ...
        public TCPHeader(byte [] byBuffer, int nReceived)
        {
            ...
            {
               // MessageBox.Show(ex.Message, "Sniffer TCP" + (nReceived), MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
